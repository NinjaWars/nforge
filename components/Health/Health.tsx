...
interface HealthProps {
    ...
    totalHealth?: number, // For entities without a character data set
...
const HealthLine = ({
    ...
    const cTotalHealth = char?.totalHealth ?? totalHealth
    const percentage = char && char?.health ? (cHealth / cTotalHealth) * 100 : 0
    return (
        <>
